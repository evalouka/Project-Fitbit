...
def classify_users(db_path='fitbit_database.db'):
    ...
    Args: db_path: Path to the SQLite database file
        
    Returns: DataFrame with columns 'Id' and 'Class'
    """
    ...
    df_classification["Id"] = df_classification["Id"].astype(int).astype(str)
